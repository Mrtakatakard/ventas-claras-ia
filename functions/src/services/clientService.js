...
exports.ClientService = {
    createClient: function (data, userId) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, clientRepository_1.ClientRepository.create(newClient)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    },
    updateClient: function (id, data, userId) {
        return __awaiter(this, void 0, void 0, function () {
            var client;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, clientRepository_1.ClientRepository.get(id)];
                    case 1:
                        client = _a.sent();
                        if (!client) {
                        ...
                        return [4 /*yield*/, clientRepository_1.ClientRepository.update(id, data)];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    deleteClient: function (id, userId) {
        return __awaiter(this, void 0, void 0, function () {
            var client;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, clientRepository_1.ClientRepository.delete(id)];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
                }
