...
exports.getAccountsReceivable = (0, https_1.onCall)(function (request) { return __awaiter(void 0, void 0, void 0, function () {
    var uid, invoicesRef, q, querySnapshot, receivableInvoices, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                logger.info("Fetching accounts receivable for user: ".concat(uid));
                _a.label = 1;
            case 1:
                _a.trys.push([1, 3, , 4]);
                invoicesRef = db.collection('invoices');
                q = invoicesRef
                    .where('userId', '==', uid)
                    .where('balanceDue', '>', 0);
            ...
            case 2:
                ...
                receivableInvoices = querySnapshot.docs.map(function (doc) { return (__assign({ id: doc.id }, doc.data())); });
                logger.info("Found ".concat(receivableInvoices.length, " receivable invoices for user: ").concat(uid));
                return [2 /*return*/, { invoices: receivableInvoices }];
            case 3:
                error_1 = _a.sent();
                logger.error("Error fetching accounts receivable:", error_1);
