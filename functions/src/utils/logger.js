...
exports.logger = {
    ...
    error: function (error, context) {
        ...
        functions.logger.error(errorObj.message, __assign(__assign({}, context), { stack: errorObj.stack }));
        if (process.env.FUNCTIONS_EMULATOR !== 'true') {
     ...
     */
    wrapFunction: function (functionName, fn) {
        return (function () {
            var args = [];
            ...
            return __awaiter(void 0, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            error_1 = _a.sent();
                            exports.logger.error(error_1, { functionName: functionName });
                            throw error_1;
