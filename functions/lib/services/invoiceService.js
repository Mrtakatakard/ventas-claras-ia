...
exports.invoiceService = {
    async createInvoice(invoiceData, userId) {
        ...
        const newInvoice = Object.assign(Object.assign({}, invoiceData), { id: invoiceId, userId, createdAt: new Date(), isActive: true });
    ...
    async updateInvoice(id, updatedData, userId) {
        await index_1.db.runTransaction(async (transaction) => {
